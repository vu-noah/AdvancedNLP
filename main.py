...
if __name__ == '__main__':
    fine_tune_bert(epochs=5, batch_size=4, mode='token_type_IDs')
    make_predictions_with_finetuned_model(batch_size=4, load_epoch=5, has_gold=True, mode='token_type_IDs')
